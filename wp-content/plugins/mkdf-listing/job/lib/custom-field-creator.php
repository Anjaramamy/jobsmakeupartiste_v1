				...
				<div class="mkdf-custom-field-wrapper mkdf-custom-text-field">
					...
					<div class="mkdf-custom-field-inner">
						...
						<div class="mkdf-custom-field-title">
							...
							<label for="mkdf_listing_job_custom_field_title[<?php echo esc_attr($this->id); ?>]">
								<?php esc_html_e('Title','mkdf-listing'); ?>
							</label>

							<input type="text" name="mkdf_listing_job_custom_field_title[<?php echo esc_attr($this->id); ?>]" value="<?php echo esc_attr($this->name); ?>"/>

						</div>

						<div class="mkdf-custom-field-default-value">

							<label for="mkdf_listing_job_custom_field_default_value[<?php echo esc_attr($this->id); ?>]">
								<?php esc_html_e('Default value','mkdf-listing'); ?>
							</label>

							<input type="text" name="mkdf_listing_job_custom_field_default_value[<?php echo esc_attr($this->id); ?>]" value="<?php echo esc_attr($this->default_value); ?>"/>

						</div>

					</div>
					<?php do_action('mkdf_listing_job_action_delete_custom_row'); ?>
					<?php do_action('mkdf_listing_job_action_expand_custom_row'); ?>
					<input type="hidden" value="text_<?php echo esc_attr($this->id); ?>" name="mkdf_listing_job_custom_field_taxonomy_type[]">
				</div>
			</td>
				...
				<div class="mkdf-custom-field-wrapper mkdf-custom-select-field" data-select-field-id = "<?php echo esc_attr($this->id); ?>">
					...
					<div class="mkdf-custom-field-inner">
						...
						<div class="mkdf-custom-select-field-option-holder" >
							...
							<?php do_action('mkdf_listing_job_action_add_repeater_option_trigger');?>

						</div>
					</div>
					<?php
                        do_action('mkdf_listing_job_action_delete_custom_row');
                        do_action('mkdf_listing_job_action_expand_custom_row');
					?>
					<input type="hidden" value="select_<?php echo esc_attr($this->id); ?>" name="mkdf_listing_job_custom_field_taxonomy_type[]">
				</div>
			</td>
		</tr>
	<?php }
	...
	public function render(){?>
		...
		<div class="mkdf-option-repeater-field-row clearfix">
			...
			<div class="mkdf-option-repeater-field-row-inner">
				<label for="mkdf_listing_job_repeater_option_label[<?php echo esc_attr($this->id); ?>][]"><?php esc_html_e('Label(*)', 'mkdf-listing') ?></label>
				<input type="text" name="mkdf_listing_job_repeater_option_label[<?php echo esc_attr($this->id); ?>][]" value="<?php echo esc_attr($this->label) ?>"/>
			</div>

			<div class="mkdf-option-repeater-field-row-inner">
				<?php
					do_action('mkdf_listing_job_action_delete_repeater_option_trigger');
				?>
			</div>
				...
				<div class="mkdf-custom-field-wrapper mkdf-custom-text-field">
					...
					<div class="mkdf-custom-field-inner">
						...
						<div class="mkdf-custom-field-default-value">
							...
							<textarea name="mkdf_listing_job_custom_field_default_value[<?php echo esc_attr($this->id); ?>]"><?php echo esc_attr($this->default_value); ?></textarea>
					...
					<?php
                        ...
                        do_action('mkdf_listing_job_action_expand_custom_row');
                     ?>
					<input type="hidden" value="textarea_<?php echo esc_attr($this->id); ?>" name="mkdf_listing_job_custom_field_taxonomy_type[]">
				</div>
			</td>
		...
		<tr class="form-field term-description-wrap custom-term-row">
			...
			<td class="form-field term-description-wrap-inner custom-term-row-inner">
				<div class="mkdf-custom-field-wrapper mkdf-custom-text-field">
					...
					<?php do_action('mkdf_listing_job_action_delete_custom_row'); ?>
					<?php do_action('mkdf_listing_job_action_expand_custom_row'); ?>
					<input type="hidden" value="checkbox_<?php echo esc_attr($this->id); ?>" name="mkdf_listing_job_custom_field_taxonomy_type[]">
				</div>
			</td>
