...
if(!function_exists('mkdf_listing_job_search_shortcode_helper')) {
	function mkdf_listing_job_shortcodes_search_helper($shortcodes_class_name) {

		$shortcodes = array(
			'MikadoListing\Lib\Shortcodes\ListingSearch'
		);
	...
	add_filter('mkdf_listing_job_filter_add_vc_shortcode', 'mkdf_listing_job_shortcodes_search_helper');
}

if(!function_exists('mkdf_listing_job_main_search_class_instance')){

	function mkdf_listing_job_main_search_class_instance(){
