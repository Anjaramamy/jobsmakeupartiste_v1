 ...
 */
class ResumeSlider implements ShortcodeInterface
{
    ...
    public function __construct() {
        ...
        $this->base = 'mkdf_listing_resume_slider';
        self::$instance = $this;
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Mikado Resume Slider', 'mkdf-listing'),
            'base'                      => $this->base,
            'category'                  => esc_html__('by MIKADO', 'mkdf-listing'),
            'icon'                      => 'icon-wpb-rs-slider extended-custom-icon',
    ...
    public function render($atts, $content = null) {
        ...
        $html = '<div class="mkdf-rs-slider-holder">';
        $html .= staffscout_mikado_execute_shortcode('mkdf_listing_resume_list', $this->getBasicParams());
        $html .= '</div>';
