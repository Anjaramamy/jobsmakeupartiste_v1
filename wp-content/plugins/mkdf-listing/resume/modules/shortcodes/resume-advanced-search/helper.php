...
if (!function_exists('mkdf_listing_resume_adv_search_shortcode_helper')) {
    function mkdf_listing_resume_adv_search_shortcode_helper($shortcodes_class_name) {

        $shortcodes = array(
            'MikadoResume\Lib\Shortcodes\ResumeAdvancedSearch'
        );
    ...
    add_filter('mkdf_listing_resume_filter_add_vc_shortcode', 'mkdf_listing_resume_adv_search_shortcode_helper');
}

if (!function_exists('mkdf_listing_resume_adv_search_class_instance')) {

    function mkdf_listing_resume_adv_search_class_instance() {
        return Shortcodes\ResumeAdvancedSearch::getInstance();
    }

}

if (!function_exists('mkdf_listing_resume_set_ls_adv_search_icon_class_name_for_vc_shortcodes')) {
    /**
     * Function that set custom icon class name for button shortcode to set our icon for Visual Composer shortcodes panel
     */
    function mkdf_listing_resume_set_ls_adv_search_icon_class_name_for_vc_shortcodes($shortcodes_icon_class_array) {
        $shortcodes_icon_class_array[] = '.icon-wpb-ls-adv-search';

        return $shortcodes_icon_class_array;
    }

    add_filter('mkdf_core_filter_add_vc_shortcodes_custom_icon_class', 'mkdf_listing_resume_set_ls_adv_search_icon_class_name_for_vc_shortcodes');
}

if (!function_exists('mkdf_listing_resume_advanced_search_response')) {

    function mkdf_listing_resume_advanced_search_response() {
        ...
        if (isset($_POST)) {
            ...
            $adv_search_obj = mkdf_listing_resume_adv_search_class_instance();
    ...
    add_action('wp_ajax_nopriv_mkdf_listing_resume_advanced_search_response', 'mkdf_listing_resume_advanced_search_response');
    add_action('wp_ajax_mkdf_listing_resume_advanced_search_response', 'mkdf_listing_resume_advanced_search_response');
}