...
class VideoButton implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Video Button', 'mkdf-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Video Image', 'mkdf-core' ),
							'description' => esc_html__( 'Select image from media library', 'mkdf-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'play_button_color',
							'heading'    => esc_html__( 'Play Button Color', 'mkdf-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'play_button_size',
							'heading'    => esc_html__( 'Play Button Size (px)', 'mkdf-core' )
						),
						array(
							'type'        => 'attach_image',
						...
						array(
							...
							'heading'     => esc_html__( 'Play Button Custom Hover Image', 'mkdf-core' ),
							'description' => esc_html__( 'Select image from media library. If you use this field then play button color and button size options will not work', 'mkdf-core' )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = mkdf_core_get_shortcode_module_template_part( 'templates/video-button', 'video-button', '', $params );
	...
	private function getPlayButtonStyles( $params ) {
		...
		if ( ! empty( $params['play_button_size'] ) ) {
			$styles[] = 'font-size: ' . staffscout_mikado_filter_px( $params['play_button_size'] ) . 'px';
		}
