...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Image Gallery', 'mkdf-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'mkdf-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'mkdf-core' ) => 'grid',
								esc_html__( 'Masonry', 'mkdf-core' )    => 'masonry',
								esc_html__( 'Slider', 'mkdf-core' )     => 'slider',
								esc_html__( 'Carousel', 'mkdf-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'mkdf-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'mkdf-core' ),
							'value'       => array_flip( staffscout_mikado_get_yes_no_select_array( false ) ),
							'save_always' => true,
	...
	public function render( $atts, $content = null ) {
		...
		$html = mkdf_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
