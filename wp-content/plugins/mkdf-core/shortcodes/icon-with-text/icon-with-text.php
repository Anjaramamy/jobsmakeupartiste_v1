...
class IconWithText implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Icon With Text', 'mkdf-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array_merge(
						array(
							...
							array(
								...
								'value'       => array(
									esc_html__( 'Icon Left From Text', 'mkdf-core' )  => 'icon-left',
									esc_html__( 'Icon Left From Title', 'mkdf-core' ) => 'icon-left-from-title',
									esc_html__( 'Icon Top', 'mkdf-core' )             => 'icon-top'
								),
								'save_always' => true
							)
						),
						staffscout_mikado_icon_collections()->getVCParamsArray(),
						array(
							array(
								'type'       => 'attach_image',
							...
							array(
								...
								'heading'     => esc_html__( 'Text Padding (px)', 'mkdf-core' ),
								'description' => esc_html__( 'Set left or top padding dependence of type for your text holder. Default value is 13 for left type and 25 for top icon with text type', 'mkdf-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return mkdf_core_get_shortcode_module_template_part( 'templates/iwt', 'icon-with-text', $params['type'], $params );
	}
	...
	private function getIconParameters( $params ) {
		...
		if ( empty( $params['custom_icon'] ) ) {
			...
			if ( ! empty( $params['custom_icon_size'] ) ) {
				$params_array['custom_size'] = staffscout_mikado_filter_px( $params['custom_icon_size'] ) . 'px';
			}
			...
			if ( ! empty( $params['shape_size'] ) ) {
				$params_array['shape_size'] = staffscout_mikado_filter_px( $params['shape_size'] ) . 'px';
			}
			...
			if ( $params['icon_border_width'] !== '' ) {
				$params_array['border_width'] = staffscout_mikado_filter_px( $params['icon_border_width'] ) . 'px';
			}
	...
	private function getContentStyles( $params ) {
		...
		if ( $params['text_padding'] !== '' && $params['type'] === 'icon-left' ) {
			$styles[] = 'padding-left: ' . staffscout_mikado_filter_px( $params['text_padding'] ) . 'px';
		}
		
		if ( $params['text_padding'] !== '' && $params['type'] === 'icon-top' ) {
			$styles[] = 'padding-top: ' . staffscout_mikado_filter_px( $params['text_padding'] ) . 'px';
		}
