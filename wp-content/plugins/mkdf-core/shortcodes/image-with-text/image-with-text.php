...
class ImageWithText implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Image With Text', 'mkdf-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
                        ...
                        array(
                            ...
                            'heading'    => esc_html__( 'Text Position', 'mkdf-core' ),
                            'value'      => array(
                                esc_html__( 'Text Below Image', 'mkdf-core' )   => 'mkdf-text-below-image',
                                esc_html__( 'Text on Image', 'mkdf-core' ) => 'mkdf-text-on-image'
                            )
                        ),
						array(
							'type'        => 'attach_image',
	...
	public function render( $atts, $content = null ) {
		$args   = array(
			'custom_class'        => '',
            'text_position'       => 'mkdf-text-below-image',
			'image'               => '',
			'image_size'          => 'full',
		...
		$html = mkdf_core_get_shortcode_module_template_part( 'templates/image-with-text', 'image-with-text', '', $params );
	...
	private function getHolderClasses( $params ) {
        ...
        $holderClasses[] = ! empty( $params['text_position'] ) ? $params['text_position'] : $args['text_position'];
