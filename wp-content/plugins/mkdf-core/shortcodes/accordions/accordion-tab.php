...
class AccordionTab implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					"name"                    => esc_html__( 'Mikado Accordion Tab', 'mkdf-core' ),
					"base"                    => $this->base,
					...
					"params"                  => array(
						array(
							...
							'description' => esc_html__( 'Enter accordion section title', 'mkdf-core' )
						),
						array(
							'type'       => 'dropdown',
	...
	public function render( $atts, $content = null ) {
		...
		$output = mkdf_core_get_shortcode_module_template_part( 'templates/accordion-template', 'accordions', '', $params );
