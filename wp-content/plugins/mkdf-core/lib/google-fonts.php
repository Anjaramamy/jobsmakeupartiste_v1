<?php
if ( ! function_exists( 'staffscout_mikado_init_google_fonts_array' ) ) {
    function staffscout_mikado_init_google_fonts_array() {
        ...
        $theme_name_php_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'staffscout_mikado_init_google_fonts_array');
}