...
class MikadoSkin extends StaffScoutMikadoClassSkinAbstract {
    /**
     * Skin constructor. Hooks to staffscout_mikado_admin_scripts_init and staffscout_mikado_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('staffscout_mikado_admin_scripts_init', array($this, 'registerStyles'));
        add_action('staffscout_mikado_admin_scripts_init', array($this, 'registerScripts'));

        add_action('staffscout_mikado_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('staffscout_mikado_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('staffscout_mikado_enqueue_meta_box_styles', array($this, 'enqueueStyles'));
        add_action('staffscout_mikado_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            staffscout_mikado_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            staffscout_mikado_register_skin_style($styleHandle, $stylePath);
        }
    }
    ...
    public function renderOptions() {
        ...
        $tab    		= staffscout_mikado_get_admin_tab();
        $active_page 	= $theme_name_php_global_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
     * @see StaffScoutMikadoClassSkinAbstract::loadTemplatePart()
     */
     ...
     *
     * @param StaffScoutMikadoClassAdminPage $page current page to load
	...
	public function renderBackupOptions() { ?>
		<div class="mkdf-options-page mkdf-page">
			<?php $this->getHeader(staffscout_mikado_get_theme_info_item('Name'), staffscout_mikado_get_theme_info_item('Version'), false); ?>
			<div class="mkdf-page-content-wrapper">
				<div class="mkdf-page-content">
					<div class="mkdf-page-navigation mkdf-tabs-wrapper vertical left clearfix">
