...
if ( ! function_exists('staffscout_mikado_contact_form_7_options_map') ) {

	function staffscout_mikado_contact_form_7_options_map() {

		staffscout_mikado_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'staffscout'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = staffscout_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'staffscout')
		));

		//Text Typography

		$typography_text_group = staffscout_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'staffscout'),
			'description'	=> esc_html__('Setup typography for form elements text', 'staffscout'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = staffscout_mikado_add_admin_row(array(
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'staffscout'),
		));
		...
		$typography_text_row2 = staffscout_mikado_add_admin_row(array(
		...
		$typography_text_row3 = staffscout_mikado_add_admin_row(array(
		...
		$typography_label_group = staffscout_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'staffscout'),
			'description'	=> esc_html__('Setup typography for form elements label', 'staffscout'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = staffscout_mikado_add_admin_row(array(
		...
		$typography_label_row2 = staffscout_mikado_add_admin_row(array(
		...
		$background_border_group = staffscout_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'staffscout'),
			'description'	=> esc_html__('Setup form elements background and border style', 'staffscout'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = staffscout_mikado_add_admin_row(array(
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'staffscout')
		));
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'staffscout')
		));

		$background_border_row2 = staffscout_mikado_add_admin_row(array(
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'staffscout'),
		));
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'staffscout')
		));
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'staffscout')
		));

		$background_border_row3 = staffscout_mikado_add_admin_row(array(
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'staffscout'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'staffscout'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = staffscout_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'staffscout'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = staffscout_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'staffscout'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'staffscout'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'staffscout'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'staffscout'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = staffscout_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'staffscout'),
			'description'	=> esc_html__('Setup form elements margin', 'staffscout'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = staffscout_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'staffscout'),
			'description'	=> esc_html__('Enter height for textarea form element', 'staffscout'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = staffscout_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'staffscout'),
			'description'	=> esc_html__('Setup button text typography', 'staffscout'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = staffscout_mikado_add_admin_row(array(
		...
		$button_typography_row2 = staffscout_mikado_add_admin_row(array(
		...
		$button_background_border_group = staffscout_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'staffscout'),
			'description'	=> esc_html__('Setup button background and border style', 'staffscout'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = staffscout_mikado_add_admin_row(array(
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'staffscout')
		));
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'staffscout')
		));

		$button_background_border_row2 = staffscout_mikado_add_admin_row(array(
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'staffscout')
		));
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'staffscout')
		));

		$button_background_border_row3 = staffscout_mikado_add_admin_row(array(
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'staffscout'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		staffscout_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'staffscout'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = staffscout_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'staffscout')
		));
        ...
        $panel_contact_form_style_3 = staffscout_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'staffscout')
        ));
        ...
        $typography_label_row3 = staffscout_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = staffscout_mikado_add_admin_row(array(
	...
	add_action( 'staffscout_mikado_options_map', 'staffscout_mikado_contact_form_7_options_map', 20);
}