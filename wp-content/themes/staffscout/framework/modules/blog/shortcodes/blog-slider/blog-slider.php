...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Mikado Blog Slider', 'staffscout' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'staffscout' )            => 'slider',
							esc_html__( 'Carousel', 'staffscout' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'staffscout' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		staffscout_mikado_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
