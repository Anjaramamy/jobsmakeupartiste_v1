...
if ( ! function_exists( 'staffscout_mikado_get_blog_holder_classes' ) ) {
	/**
	 * Function that generates blog holder classes for blog page
	 */
	function staffscout_mikado_get_blog_holder_classes( $classes ) {
	...
	add_filter( 'staffscout_mikado_blog_holder_classes', 'staffscout_mikado_get_blog_holder_classes' );
}
