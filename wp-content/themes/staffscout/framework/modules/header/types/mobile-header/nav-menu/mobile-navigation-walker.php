...
if (!class_exists('StaffScoutMikadoClassMobileNavigationWalker')) {
	class StaffScoutMikadoClassMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            if ($item->additional_label != '') {
                $additional_label = $item->additional_label;
            }
			...
			if($item->hide == ""){
                ...
                if($additional_label !== '') {
                    ...
                    $item_output .= '<span class="item_additional_label">';

                    $item_output .= $additional_label;

                    $item_output .= '</span>'; //close span.item_additional_label
                }

				if($args->has_children) {
					$item_output .= '<span class="mobile_arrow"><i class="dripicon dripicons-chevron-down"></i></span>';
				}
			}
