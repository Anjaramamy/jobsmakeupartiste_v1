...
class HeaderStandard extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$menu_area_position                     = staffscout_mikado_get_meta_field_intersect( 'set_menu_area_position', $page_id );
		...
		$parameters = apply_filters( 'staffscout_mikado_header_standard_parameters', $parameters );
