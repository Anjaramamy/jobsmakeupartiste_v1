 ...
 *
 * Class StaffScoutMikadoClassWidget
 */
abstract class StaffScoutMikadoClassWidget extends WP_Widget {
    /**
    ...
    public function form($instance) {
        if(is_array($this->params) && count($this->params)) {
            ...
            <p><?php esc_html_e('There are no options for this widget.', 'staffscout'); ?></p>
        <?php }
    }
