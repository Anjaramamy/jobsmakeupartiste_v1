...
class ProductListSimple implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Product List - Simple', 'staffscout' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						array(
							...
							'value'      => array(
								esc_html__( 'Sale', 'staffscout' )         => 'sale',
								esc_html__( 'Best Sellers', 'staffscout' ) => 'best-sellers',
								esc_html__( 'Featured', 'staffscout' )     => 'featured'
							),
							'save_always' => true
						),
						array(
							...
							'description' => esc_html__( 'Number of products to show (default value is 4)', 'staffscout' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'order_by',
	...
	public function render( $atts, $content = null ) {
		...
		$html = staffscout_mikado_get_woo_shortcode_module_template_part( 'templates/product-list-template', 'product-list-simple', '', $params );
