...
class StaffScoutMikadoClassSimpleLineIcons implements iStaffScoutMikadoInterfaceIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'staffscout'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'staffscout'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'staffscout'),
            'icon-social-facebook'    => esc_html__('Facebook', 'staffscout'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'staffscout'),
            'icon-social-github'      => esc_html__('Github', 'staffscout'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'staffscout'),
            'icon-social-instagram'   => esc_html__('Instagram', 'staffscout'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'staffscout'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'staffscout'),
            'icon-social-reddit'      => esc_html__('Reddit', 'staffscout'),
            'icon-social-skype'       => esc_html__('Skype', 'staffscout'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'staffscout'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'staffscout'),
            'icon-social-spotify'     => esc_html__('Spotify', 'staffscout'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'staffscout'),
            'icon-social-twitter'     => esc_html__('Twitter', 'staffscout'),
            'icon-social-youtube'     => esc_html__('Youtube', 'staffscout')
        );
    }
